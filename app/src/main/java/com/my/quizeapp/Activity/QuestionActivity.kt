...
import com.my.quizeapp.Adapter.QuestionAdapter
import com.my.quizeapp.Domain.QuestionModel
import com.my.quizeapp.R
import com.my.quizeapp.databinding.ActivityQuestionBinding
...
class QuestionActivity : AppCompatActivity(), QuestionAdapter.score {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            questionTx.text= receivedList[position].question
